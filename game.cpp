		...
		if (blockType == BLOCK_DEFENSE) {
			...
			switch (combatType) {
				...
				case COMBAT_HOLYDAMAGE: {
					hitEffect = CONST_ME_HOLYATTACK;
					break;
				}
				case COMBAT_DEATHDAMAGE: {
					hitEffect = CONST_ME_DEATHATTACK;
					break;
				}
				default: {
...
void Game::combatGetTypeInfo(CombatType_t combatType, Creature* target, TextColor_t& color, uint8_t& effect)
{
	switch (combatType) {
		...
		case COMBAT_DARKDAMAGE: {
			...
			effect = CONST_ME_GREEN_RINGS;  // here is the effect of your damage
			break;
		}
		...
		case COMBAT_HOLYDAMAGE: {
			...
			effect = CONST_ME_HOLYATTACK;
			break;
		}

		case COMBAT_DEATHDAMAGE: {
			color = TEXTCOLOR_DARKRED;
			effect = CONST_ME_DEATHATTACK;
			break;
		}
