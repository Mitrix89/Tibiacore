...
enum MagicEffectClasses : uint8_t {
	...
	CONST_ME_ICEATTACK = 30,
	CONST_ME_HOLYATTACK = 29,
	CONST_ME_DEATHATTACK = 31,
	CONST_ME_FIRESTRIKE = 34,
};
...
enum ShootType_t : uint8_t {
	...
	CONST_ANI_POISON = 15,
	CONST_ANI_ICEATTACK = 33,
	CONST_ANI_HOLYATTACK = 32,
	CONST_ANI_FIRESTRIKE = 35,
	CONST_ANI_DEATHATTACK = 36,
};
...
enum item_t : uint16_t {
	...
	ITEM_AMULET_SPECIAL = 4483,
	ITEM_AMULET_SPECIAL_BACK = 4482,
...
static constexpr int32_t CHANNEL_LOOT = 0x21;
